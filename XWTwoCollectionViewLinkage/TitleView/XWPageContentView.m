...
@interface XWPageContentView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation XWPageContentView
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(XWContentViewWillBeginDragging:)]) {
        [self.delegate XWContentViewWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(XWContentViewDidScroll:startIndex:endIndex:progress:)]) {
        [self.delegate XWContentViewDidScroll:self startIndex:startIndex endIndex:endIndex progress:progress];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(XWContenViewDidEndDecelerating:startIndex:endIndex:)]) {
        [self.delegate XWContenViewDidEndDecelerating:self startIndex:startIndex endIndex:endIndex];
    }
}
...
{
    if (!decelerate) {
        if (self.delegate && [self.delegate respondsToSelector:@selector(XWContenViewDidEndDragging:)]) {
            [self.delegate XWContenViewDidEndDragging:self];
        }
    }
}
